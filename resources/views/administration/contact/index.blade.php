...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">Liste des adresses E-mail</h3>
                        ...
                        <td style="text-align:center;">
                            <span class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end"
                                    ...
                                    <form action="{{ route('contact.destroy', $contact->id)}}" method="POST" id="formDelete">
                                        @csrf
                                        @method('DELETE')
...
<script>
    ...
    var active  = document.getElementById('index_contact');
