    ...
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Compte</span>
                    </a>
                </li>
                <li class="m-nav__separator">-</li>
                <li class="m-nav__item">
...
<div class="m-content">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            action="{{route('compte.update')}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!--begin::Portlet-->
                                ...
                                <div class="col-xl-12">
                                        <div class="m-form__section m-form__section--first">
                                            <div class="form-group m-form__group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">* Ancien mot de passe  :</label>
                                            ...
                                            <div class="form-group m-form__group row">
                                                <label class="col-xl-3 col-lg-3 col-form-label">*Confirmer nouveau mot de passe :</label>
                                                <div class="col-xl-6 col-lg-6">
...
<script>
    ...
    var active  = document.getElementById('change_password');
